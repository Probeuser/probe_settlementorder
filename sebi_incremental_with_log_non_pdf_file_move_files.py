...
download_folder = r"C:\Users\mohan.7482\Desktop\sebi_final_script\so\pdfdownload\settlementorder"
...
def move_files_to_specific_folder(file_name_excel_path, type_sebi_text):
    ...
    try:
        ...
        def save_to_excel():
            ...
            final_excel_sheets_path = fr"C:\Users\mohan.7482\Desktop\sebi_final_script\so\final_excel_sheets\{final_excel_sheets_name}"
        ...
        def create_year_folders(selected_year_rows,year,months):
            year_folder_path = os.path.join(download_folder,year)
            ...
            if shadow_element:
                ...
                if print_preview_app :
                    ...
                    if shadow_element:
                        ...
                        shadow_element.click()
                        time.sleep(10)
                        file_name_with_path = fr"C:\Users\mohan.7482\Desktop\sebi_final_script\so\pdfdownload\settlementorder\settlementorder_{name}_{index}.pdf"
...
def download_pdf_files(df, type_sebi_text):
    ...
    file_name_excel_path = fr"C:\Users\mohan.7482\Desktop\sebi_final_script\so\file_name_excel_sheets\{excel_with_final_name}"

    try:
        for index, row in df.iterrows():
            link = row['link_to_order']
...
def find_new_data(excel_file_path, db_table_name, type_sebi_text):
    ...
    try:
        ...
        if not missing_rows.empty:
            ...
            print(missing_rows)
            new_excel_file_path = rf"C:\Users\mohan.7482\Desktop\sebi_final_script\so\incremental_excel_sheets\Missing_Data_{type_sebi_text}{current_date}.xlsx"
...
def check_new_data(excel_file_path, cursor, type_sebi_text):
    ...
    try:
        ...
        print(number_new_data,"number of new record")
...
def extract_data_website(cursor):
    ...
    try:
        ...
        excel_file_path = rf"C:\Users\mohan.7482\Desktop\sebi_final_script\so\first_set_excel_sheet_files\{excel_file_name}"
